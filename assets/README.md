...
- Generation: `scripts/generate-stow-icon.py` derives the shipped PNG/ICO from the approved master; `scripts/generate-stow-hero.py` uses Pillow as development tooling.
